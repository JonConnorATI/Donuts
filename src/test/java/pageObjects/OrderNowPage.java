...
public class OrderNowPage extends CommonMethods {
	...
	/* replaced with a generic method pickFromOffBeatDozen()
	 * public static void getGlazedDozen() { WebElement Element =
	 * driver.findElement(By.xpath("//a[@data-tab='offbeat-dozen']"));
	 * Element.isEnabled(); JavascriptExecutor js = (JavascriptExecutor) driver;
	 * js.executeScript("arguments[0].scrollIntoView();", Element);
	 * 
	 * while (isElementPresent(By.
	 * xpath("//*[@class='swiper-button-next next_offbeat-dozen']")) == true) {
	 * Click(By.xpath("//*[@class='swiper-button-next next_offbeat-dozen']")); }
	 * 
	 * Click(By.
	 * xpath("//h3[text() ='Classic Glazed Dozen']//following-sibling::div[@class='btn select']"
	 * ));
	 * 
	 * }
	 */
	...
	/* replaced with a generic method pickFromOffBeatDozen()
	 * public static void getOffbeatDozen() { WebElement Element =
	 * driver.findElement(By.xpath("//a[@data-tab='offbeat-dozen']"));
	 * Element.isEnabled(); JavascriptExecutor js = (JavascriptExecutor) driver;
	 * js.executeScript("arguments[0].scrollIntoView();", Element); Click(By.
	 * xpath("//h3[text() ='Offbeat Dozen']//following-sibling::div[@class='btn select']"
	 * ));
	 * 
	 * 
	 * }
	...
	/* replaced with generic method pickFromOffBeatDozen()
	 * public static void getBirthdayDoubleDozen() { WebElement Element =
	 * driver.findElement(By.xpath("//a[@data-tab='offbeat-dozen']"));
	 * Element.isEnabled(); JavascriptExecutor js = (JavascriptExecutor) driver;
	 * js.executeScript("arguments[0].scrollIntoView();", Element);
	 * 
	 * //while (!isElementPresent(By.
	 * xpath("//h3[text() ='Birthday Double Dozen']//following-sibling::div[@class='btn select']"
	 * )) == false) {
	 * Click(By.xpath("//*[@class='swiper-button-next next_offbeat-dozen']"));
	 * Click(By.xpath("//*[@class='swiper-button-next next_offbeat-dozen']"));
	 * Click(By.xpath("//*[@class='swiper-button-next next_offbeat-dozen']"));
