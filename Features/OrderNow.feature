...
Then I should be in the order now page and see
...
Then I should see these items in the Boxes summary with an image 
|Boxes:|
|+|
...
Then I should see a pop up with
|Your box was added to cart|
|VIEW CART|
|Start another box|
When I select View Cart
Then I should see the items I chose
|my cart (1 items)|
|Classic Glazed Dozen|
